 ...
 * @time 9:20 AM
 */
public class VListRenderer<F extends HtmlFormatter,I,P> implements Renderer<F,Integer,List<I>,P>  {

    protected Renderer<F,Integer,I,P> itemRenderer;

    public VListRenderer(Renderer<F,Integer,I,P> itemRenderer) { this.itemRenderer=itemRenderer; }
