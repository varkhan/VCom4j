...
import net.varkhan.pres.widget.Orientation;
 ...
 * @time 9:23 PM
 */
public class VMenuSelectorRenderer<W extends Widget<String[],P> & Located<String[], P>,P> implements MenuSelectorRenderer<HtmlFormatter,W,P> {
