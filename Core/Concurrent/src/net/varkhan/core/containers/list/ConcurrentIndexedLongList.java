...
import net.varkhan.base.containers.type.IndexedLongCollection;
import net.varkhan.base.containers.type.LongIterable;


/**
 * <b>A thread-safe list of {@code long}s that allow for arbitrary element positions.</b>.
 * <p/>
 * This list stores {@code long}s in arbitrary positions (their index, in the
 ...
 * @time 4:39:05 AM
 */
public interface ConcurrentIndexedLongList extends ConcurrentIndexedList<Long>, IndexedLongCollection {
     ...
     */
    public long setIfAbsent(long index, long val);
     ...
     */
    public long rep(long index, long oldval, long newval);
     ...
     */
    public boolean del(long index, long val);
     ...
     */
    public LongIterable iterate(long[] indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public LongIterable iterate(Iterable<Long> indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public LongIterable iterate(Indexable indexes);
