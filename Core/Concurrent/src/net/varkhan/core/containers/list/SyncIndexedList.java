 ...
 * @time 7:18:56 PM
 */
public class SyncIndexedList<Type> implements ConcurrentIndexedList<Type>, Serializable {

    private static final long serialVersionUID=1L;

    private final Lock              rlock;
    private final Lock              wlock;
    private final IndexedList<Type> list;
     ...
     */
    public SyncIndexedList(IndexedList<Type> list) {
        this.list=list;
     ...
     */
    public SyncIndexedList(IndexedList<Type> list, Lock rlock, Lock wlock) {
        this.list=list;
        this.rlock=rlock;
        this.wlock=wlock;
    }
    ...
    public Iterator<? extends Type> iterator() {
        ...
        try {
            return new Iterator<Type>() {
                final Iterator<? extends Type> iterator=list.iterator();
                private long exid=opid;
    ...
    public <Par> long visit(final Visitor<Type,Par> vis, Par par) {
        rlock.lock();
        try {
            return list.visit(new Visitor<Type,Par>() {
                private final long exid=opid;
    ...
    public <Par> long visit(final IndexedVisitor<Type,Par> vis, Par par) {
        rlock.lock();
        try {
            return list.visit(new IndexedVisitor<Type,Par>() {
                private final long exid=opid;
    ...
    public Iterable<? extends Type> iterate(final long[] indexes) {
        return new Iterable<Type>() {
            public Iterator<Type> iterator() {
                ...
                try {
                    return new Iterator<Type>() {
                        final Iterator<? extends Type> iterator=list.iterate(indexes).iterator();
                        private long exid=opid;
