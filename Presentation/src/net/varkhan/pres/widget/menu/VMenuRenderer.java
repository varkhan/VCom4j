 ...
 * @time 9:23 PM
 */
public class VMenuRenderer<P> implements Renderer<HtmlFormatter,String[],Menu<Widget<P>>,P> {
    ...
    private VMenuRenderer<P> subrdr = this;
    ...
    public void render(HtmlFormatter fmt, String[] loc, Menu<Widget<P>> obj, P par) throws IOException {
        ...
        while(it.hasNext()) {
            ...
            boolean selected = loc.length>0 && item.id().equals(loc[0]);
