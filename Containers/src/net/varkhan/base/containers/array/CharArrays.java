...
public class CharArrays {
    ...
    /**
     * Indicates whether a value is contained in a char array.
     *
     ...
     */
    public static boolean isMember(char item, char[] array) {
        if(array==null) return false;
        for(char elem : array) if(item==elem) return true;
        return false;
    }
     ...
     *         of {@code array})
     */
    public static int indexOf(char[] array, int pos, char[] sub) {
