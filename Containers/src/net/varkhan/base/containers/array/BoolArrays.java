...
public class BoolArrays {
    ...
    /**
     * Indicates whether a value is contained in a boolean array.
     *
     ...
     */
    public static boolean isMember(boolean item, boolean[] array) {
        if(array==null) return false;
        for(boolean elem : array) if(item==elem) return true;
        return false;
    }
