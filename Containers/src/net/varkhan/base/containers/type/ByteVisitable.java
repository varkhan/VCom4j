 ...
 * @time 4:31:51 AM
 */
public interface ByteVisitable extends Visitable<Byte> {

    public interface ByteVisitor<Par> {
        /**
         ...
         */
        public long invoke(byte obj, Par par);
    }
     ...
     */
    public <Par> long visit(ByteVisitor<Par> vis, Par par);
