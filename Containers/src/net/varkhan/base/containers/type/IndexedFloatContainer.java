 ...
 * <p/>
 * This container stores floats, that are mapped to a unique index through
 * which they can be retrieved. An {@link Index} over those indexes, and
 * several {@link FloatIterable.FloatIterator}s allow access to all the elements of the collection.
 * <p/>
 *
 * @author varkhan
 * @date Mar 11, 2009
 * @time 1:19:16 AM
 */
public interface IndexedFloatContainer extends IndexedContainer<Float>, FloatIterable, FloatVisitable, IndexedFloatVisitable {
