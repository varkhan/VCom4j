 ...
 * <p/>
 * This container stores longs, that are mapped to a unique index through
 * which they can be retrieved. An {@link Index} over those indexes, and
 * several {@link LongIterable.LongIterator}s allow access to all the elements of the collection.
 * <p/>
 *
 * @author varkhan
 * @date Mar 11, 2009
 * @time 1:19:16 AM
 */
public interface IndexedLongContainer extends IndexedContainer<Long>, LongIterable, LongVisitable, IndexedLongVisitable {
