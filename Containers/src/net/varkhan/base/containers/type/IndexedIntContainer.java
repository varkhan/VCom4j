 ...
 * <p/>
 * This container stores ints, that are mapped to a unique index through
 * which they can be retrieved. An {@link Index} over those indexes, and
 * several {@link IntIterable.IntIterator}s allow access to all the elements of the collection.
 * <p/>
 *
 * @author varkhan
 * @date Mar 11, 2009
 * @time 1:19:16 AM
 */
public interface IndexedIntContainer extends IndexedContainer<Integer>, IntIterable, IntVisitable, IndexedIntVisitable {
