 ...
 * @time 4:31:51 AM
 */
public interface CharVisitable extends Visitable<Character> {

    public interface CharVisitor<Par> {
        /**
         ...
         */
        public long invoke(char obj, Par par);
    }
     ...
     */
    public <Par> long visit(CharVisitor<Par> vis, Par par);
