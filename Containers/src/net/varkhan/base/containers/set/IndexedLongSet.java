 ...
 * @time 1:39:19 AM
 */
public interface IndexedLongSet extends IndexedSet<Long>, IndexedLongCollection {
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public LongIterable iterate(java.lang.Iterable<Long> indexes);
     ...
     */
    public static interface LongEntry extends IndexedSet.Entry<Long> {
     ...
     */
    public Iterable<? extends LongEntry> entries();
     ...
     */
    public Iterable<? extends LongEntry> entries(long[] indexes);
     ...
     * @return an iterable over all the entries designated by the identifiers
     */
    public Iterable<? extends LongEntry> entries(Iterable<Long> indexes);
     ...
     * @return an iterable over all the entries designated by the identifiers
     */
    public Iterable<? extends LongEntry> entries(Indexable indexes);
