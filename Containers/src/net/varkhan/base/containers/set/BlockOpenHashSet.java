...
public class BlockOpenHashSet<Key> implements Set<Key>, Serializable, Cloneable {
     ...
     */
    public BlockOpenHashSet(long size, int blockshift, float loadfact, float growfact, final HashingStrategy<Key> strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
    ...
    public BlockOpenHashSet(long size) {
    ...
    public Iterator<Key> iterator() {
        return new Iterator<Key>() {
            ...
            {
                Object k;
                if(c!=0) while(pos<BlockOpenHashSet.this.capa&&((k=_getKey(pos))==NULL||k==DEL)) pos++;
            }

            public boolean hasNext() {
                return c!=0&&pos<BlockOpenHashSet.this.capa;
            }
            ...
            public Key next() {
                ...
                Object k;
                if(--c!=0) do pos++; while(pos<BlockOpenHashSet.this.capa&&((k=_getKey(pos))==NULL||k==DEL));
                return key;
            }
