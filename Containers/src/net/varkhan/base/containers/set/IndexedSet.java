 ...
 * <p/>
 * An indexed set of objects, that associates with each unique object (element,
 ...
 * @time 1:39:19 AM
 */
public interface IndexedSet<Key> extends IndexedSearchable<Key,Key>, IndexedCollection<Key> {
     ...
     */
    public static interface Entry<Type> {
