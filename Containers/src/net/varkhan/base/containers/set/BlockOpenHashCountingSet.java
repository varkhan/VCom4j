 ...
 * @time 9:43:13 PM
 */
public class BlockOpenHashCountingSet<Key,Value> implements CountingSet<Key>, Serializable {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
    ...
    @SuppressWarnings("unchecked")
    public Object clone() {
        BlockOpenHashCountingSet<Key,Value> c;
        try {
            c=(BlockOpenHashCountingSet<Key,Value>) super.clone();
        }
