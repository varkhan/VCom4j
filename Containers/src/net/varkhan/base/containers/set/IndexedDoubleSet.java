 ...
 * @time 1:39:19 AM
 */
public interface IndexedDoubleSet extends IndexedSet<Double>, IndexedDoubleCollection {
     ...
     */
    public static interface DoubleEntry extends IndexedSet.Entry<Double> {
     ...
     */
    public Iterable<? extends DoubleEntry> entries();
     ...
     */
    public Iterable<? extends DoubleEntry> entries(long[] indexes);
     ...
     * @return an iterable over all the entries designated by the identifiers
     */
    public Iterable<? extends DoubleEntry> entries(Iterable<Long> indexes);
     ...
     * @return an iterable over all the entries designated by the identifiers
     */
    public Iterable<? extends DoubleEntry> entries(Indexable indexes);
