 ...
 * @time 3:37:27 AM
 */
public interface IndexedDouble2FloatMap extends IndexedMap<Double,Float>/*, IndexedObj2FloatMap<Double>, IndexedDouble2ObjMap<Float>*/ {
     ...
     */
    public interface Entry extends IndexedMap.Entry<Double,Float>, IndexedObj2FloatMap.Entry<Double>, IndexedDouble2ObjMap.Entry<Float> {
     ...
     */
    public void setDefaultKey(double def);
     ...
     */
    public long add(double key, float val);
     ...
     */
    public Iterator<? extends IndexedDouble2FloatMap.Entry> iterator();
     ...
     */
    public Iterable<? extends IndexedDouble2FloatMap.Entry> iterate(long[] indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedDouble2FloatMap.Entry> iterate(java.lang.Iterable<Long> indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedDouble2FloatMap.Entry> iterate(Indexable indexes);
