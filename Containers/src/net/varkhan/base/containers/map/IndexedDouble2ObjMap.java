 ...
 * @time 3:37:27 AM
 */
public interface IndexedDouble2ObjMap<Value> extends IndexedMap<Double,Value> {
     ...
     */
    public interface Entry<Value> extends IndexedMap.Entry<Double,Value> {
     ...
     */
    public long add(double key, Value val);
     ...
     */
    public Iterator<? extends IndexedDouble2ObjMap.Entry<Value>> iterator();
     ...
     */
    public Iterable<? extends IndexedDouble2ObjMap.Entry<Value>> iterate(long[] indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedDouble2ObjMap.Entry<Value>> iterate(java.lang.Iterable<Long> indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedDouble2ObjMap.Entry<Value>> iterate(Indexable indexes);
