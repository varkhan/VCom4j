 ...
 * @time 9:43:13 PM
 */
public class ArrayOpenHashIndexedFloat2ObjMap<Value> implements IndexedFloat2ObjMap<Value>, Serializable, Cloneable {
     ...
     */
    public ArrayOpenHashIndexedFloat2ObjMap(long size, float loadfact, float growfact, final FloatHashingStrategy strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
     ...
     * @param size the expected number of elements in the set
     */
    public ArrayOpenHashIndexedFloat2ObjMap(long size) {
        this(size, .75f, 1.5f, FloatHashingStrategy.DefaultHashingStrategy);
    }

    /**
     * Creates a new hash set.
     */
    public ArrayOpenHashIndexedFloat2ObjMap() {
        this(11, .75f, 1.5f, FloatHashingStrategy.DefaultHashingStrategy);
    }
...
//            } while( sidx<0 || (sidx>0 && ! (strategy.hash((Key)(kval=getKey(sidx-1)))==hash && strategy.equal((Key)key, (Key)kval) )) );
    ...
    protected void rehash(final int capa) {
        ...
        if(this.keys.length<capa) {
            final float[] keys=new float[capa];
        ...
        // Decrease the size of the keys if possible
            ...
            final float[] keys=new float[knum];
    ...
    private class Entry implements IndexedFloat2ObjMap.Entry<Value> {
        ...
        public Entry(int idx, float key) {
            this.idx=idx;
            this.key=key;
        }
    ...
    public Index indexes() {
        return new Index() {
            ...
            int c=ArrayOpenHashIndexedFloat2ObjMap.this.size;
            ...
            public boolean hasNext() {
                ...
                if(next==-1) {
                    next=curr+1;
                    while(next<ArrayOpenHashIndexedFloat2ObjMap.this.capa&&idxs[next]<=0) next++;
                }
                return next<ArrayOpenHashIndexedFloat2ObjMap.this.capa;
            }
            ...
            public boolean hasPrevious() {
                if(c==ArrayOpenHashIndexedFloat2ObjMap.this.size) return false;
                if(last==-1) {
                    last=curr-1;
        ...
        return new java.lang.Iterable<Long>() {
            public java.util.Iterator<Long> iterator() {
                return new java.util.Iterator<Long>() {
                    ...
                    {
                        if(c!=0) while(pos<ArrayOpenHashIndexedFloat2ObjMap.this.capa&&idxs[pos]<=0) pos++;
                    }

                    public boolean hasNext() {
                        return c!=0&&pos<ArrayOpenHashIndexedFloat2ObjMap.this.capa;
                    }

                    public Long next() {
                        if(!hasNext()) throw new NoSuchElementException();
                        int idx=idxs[(last=pos)]-1;
                        if(--c!=0) do pos++; while(pos<ArrayOpenHashIndexedFloat2ObjMap.this.capa&&idxs[pos]<=0);
                        return (long) idx;
                    }
    ...
    public IndexedFloatContainer keys() {
        return new IndexedFloatContainer() {
            public long size() { return ArrayOpenHashIndexedFloat2ObjMap.this.size(); }
            public boolean isEmpty() { return ArrayOpenHashIndexedFloat2ObjMap.this.isEmpty(); }
            public long head() { return ArrayOpenHashIndexedFloat2ObjMap.this.head(); }
            public float getDefaultValue() {  return ArrayOpenHashIndexedFloat2ObjMap.this.getDefaultKey(); }
            public boolean has(long index) { return ArrayOpenHashIndexedFloat2ObjMap.this.has(index); }
            public Float get(long index) { return ArrayOpenHashIndexedFloat2ObjMap.this.getKey(index); }
            public float getFloat(long index) { return ArrayOpenHashIndexedFloat2ObjMap.this.getFloatKey(index); }
            public Index indexes() { return ArrayOpenHashIndexedFloat2ObjMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedFloat2ObjMap.this.iterateIndexes(); }
...
//                                keys[last]=0;
    ...
    public IndexedContainer<Value> values() {
        return new IndexedContainer<Value>() {
            ...
            public long head() { return ArrayOpenHashIndexedFloat2ObjMap.this.head(); }
            public boolean has(long index) { return ArrayOpenHashIndexedFloat2ObjMap.this.has(index); }
            public Value get(long index) { return ArrayOpenHashIndexedFloat2ObjMap.this.getValue(index); }
            public Index indexes() { return ArrayOpenHashIndexedFloat2ObjMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedFloat2ObjMap.this.iterateIndexes(); }
...
//                                keys[last]=0;
     ...
     */
    @SuppressWarnings("unchecked")
    public ArrayOpenHashIndexedFloat2ObjMap<Value> clone() {
        ArrayOpenHashIndexedFloat2ObjMap<Value> c;
        try {
            c=(ArrayOpenHashIndexedFloat2ObjMap<Value>) super.clone();
        }
