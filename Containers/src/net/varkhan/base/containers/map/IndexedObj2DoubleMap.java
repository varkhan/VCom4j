 ...
 * @time 3:37:27 AM
 */
public interface IndexedObj2DoubleMap<Key> extends IndexedMap<Key,Double> {
     ...
     */
    public interface Entry<Key> extends IndexedMap.Entry<Key,Double> {
     ...
     */
    public long add(Key key, double val);
     ...
     */
    public Iterator<? extends IndexedObj2DoubleMap.Entry<Key>> iterator();
     ...
     */
    public Iterable<? extends IndexedObj2DoubleMap.Entry<Key>> iterate(long[] indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedObj2DoubleMap.Entry<Key>> iterate(java.lang.Iterable<Long> indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedObj2DoubleMap.Entry<Key>> iterate(Indexable indexes);
