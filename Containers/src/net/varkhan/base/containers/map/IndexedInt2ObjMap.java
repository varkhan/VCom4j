 ...
 * @time 3:37:27 AM
 */
public interface IndexedInt2ObjMap<Value> extends IndexedMap<Integer,Value> {
     ...
     */
    public interface Entry<Value> extends IndexedMap.Entry<Integer,Value> {
     ...
     */
    public void setDefaultKey(int def);
     ...
     */
    public long add(int key, Value val);
     ...
     */
    public Iterator<? extends IndexedInt2ObjMap.Entry<Value>> iterator();
     ...
     */
    public Iterable<? extends IndexedInt2ObjMap.Entry<Value>> iterate(long[] indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedInt2ObjMap.Entry<Value>> iterate(java.lang.Iterable<Long> indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedInt2ObjMap.Entry<Value>> iterate(Indexable indexes);
