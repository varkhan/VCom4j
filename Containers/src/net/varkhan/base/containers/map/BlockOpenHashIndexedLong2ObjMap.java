 ...
 * @time 9:43:13 PM
 */
public class BlockOpenHashIndexedLong2ObjMap<Value> implements IndexedLong2ObjMap<Value>, Serializable, Cloneable {
     ...
     */
    public BlockOpenHashIndexedLong2ObjMap(long size, int blockshift, float loadfact, float growfact, final LongHashingStrategy strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
     ...
     * @param size the expected number of elements in the map
     */
    public BlockOpenHashIndexedLong2ObjMap(long size) {
     ...
     * Creates a new hash map.
     */
    public BlockOpenHashIndexedLong2ObjMap() {
    ...
    private void _setEntry(long index, long k, Object v) {
        int kblockpos=(int) (index>>>this.blockshift);
        int kblockoff=(int) (index&this.blockmask);
        long[] kblock=this.keys[kblockpos];
        Object[] vblock=this.vals[kblockpos];
    ...
    public long add(IndexedMap.Entry<Long,Value> item) {
    ...
    public long add(final Long key, final Value val) {
        if(key==null) return -1;
...
//            } while( sidx<0 || (sidx>0 && ! (hash == this.strategy.hash((Key)(kval=getKey(sidx-1))) && this.strategy.equal(key, (Key)kval))) );
     ...
     */
    @SuppressWarnings("unchecked")
    private class Entry implements IndexedLong2ObjMap.Entry<Value> {
    ...
    public Index indexes() {
        return new Index() {
            ...
            long c=BlockOpenHashIndexedLong2ObjMap.this.size;
            ...
            public boolean hasNext() {
                ...
                if(next==-1) {
                    next=curr+1;
                    while(next<BlockOpenHashIndexedLong2ObjMap.this.capa&&_getIndex(next)<=0) next++;
                }
                return next<BlockOpenHashIndexedLong2ObjMap.this.capa;
            }
            ...
            public boolean hasPrevious() {
                if(c==BlockOpenHashIndexedLong2ObjMap.this.size) return false;
                if(last==-1) {
                    last=curr-1;
        ...
        return new java.lang.Iterable<Long>() {
            public java.util.Iterator<Long> iterator() {
                return new java.util.Iterator<Long>() {
                    ...
                    {
                        if(c!=0) while(pos<BlockOpenHashIndexedLong2ObjMap.this.capa&&_getIndex(pos)<=0) pos++;
                    }

                    public boolean hasNext() {
                        return c!=0&&pos<BlockOpenHashIndexedLong2ObjMap.this.capa;
                    }

                    public Long next() {
                        if(!hasNext()) throw new NoSuchElementException();
                        long idx=_getIndex(last=pos)-1;
                        if(--c!=0) do pos++; while(pos<BlockOpenHashIndexedLong2ObjMap.this.capa&&_getIndex(pos)<=0);
                        return idx;
                    }
    ...
    public Iterator<IndexedLong2ObjMap.Entry<Value>> iterator() {
        return new Iterator<IndexedLong2ObjMap.Entry<Value>>() {
            /** The position of the next entry to be returned. */
            long pos=0;
            /** The position of the last entry that has been returned. */
            long last=-1;
            ...
            public IndexedLong2ObjMap.Entry<Value> next() {
                if(!hasNext()) throw new NoSuchElementException();
                long idx=_getIndex(last=pos)-1;
                if(--c!=0) do pos++; while(pos<BlockOpenHashIndexedLong2ObjMap.this.capa&&_getIndex(pos)<=0);
    ...
    public <Par> long visit(Visitor<IndexedMap.Entry<Long,Value>,Par> vis, Par par) {
        long c=0;
        int pos=0;
        while(pos<capa) {
    ...
    public <Par> long visit(IndexedVisitor<IndexedMap.Entry<Long,Value>,Par> vis, Par par) {
        long c=0;
        int pos=0;
        while(pos<capa) {
            long idx=_getIndex(pos);
    ...
    public Iterable<IndexedLong2ObjMap.Entry<Value>> iterate(final long[] indexes) {
        return new Iterable<IndexedLong2ObjMap.Entry<Value>>() {
            public Iterator<IndexedLong2ObjMap.Entry<Value>> iterator() {
                return new Iterator<IndexedLong2ObjMap.Entry<Value>>() {
    ...
    public Iterable<IndexedLong2ObjMap.Entry<Value>> iterate(final java.lang.Iterable<Long> indexes) {
        return new Iterable<IndexedLong2ObjMap.Entry<Value>>() {
            public Iterator<IndexedLong2ObjMap.Entry<Value>> iterator() {
                return new Iterator<IndexedLong2ObjMap.Entry<Value>>() {
    ...
    public Iterable<IndexedLong2ObjMap.Entry<Value>> iterate(final Indexable indexes) {
        return new Iterable<IndexedLong2ObjMap.Entry<Value>>() {
            public Iterator<IndexedLong2ObjMap.Entry<Value>> iterator() {
                return new Iterator<IndexedLong2ObjMap.Entry<Value>>() {
                    /** An iterator over indexes */
    ...
    public IndexedLongContainer keys() {
        return new IndexedLongContainer() {
            public long size() { return BlockOpenHashIndexedLong2ObjMap.this.size(); }
            public boolean isEmpty() { return BlockOpenHashIndexedLong2ObjMap.this.isEmpty(); }
            public long head() { return BlockOpenHashIndexedLong2ObjMap.this.head(); }
            public long getDefaultValue() { return BlockOpenHashIndexedLong2ObjMap.this.getDefaultKey(); }
            public boolean has(long index) { return BlockOpenHashIndexedLong2ObjMap.this.has(index); }
            public Long get(long index) { return BlockOpenHashIndexedLong2ObjMap.this.getKey(index); }
            public long getLong(long index) { return BlockOpenHashIndexedLong2ObjMap.this.getLongKey(index); }
            public Index indexes() { return BlockOpenHashIndexedLong2ObjMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return BlockOpenHashIndexedLong2ObjMap.this.iterateIndexes(); }
    ...
    public IndexedContainer<Value> values() {
        return new IndexedContainer<Value>() {
            ...
            public long head() { return BlockOpenHashIndexedLong2ObjMap.this.head(); }
            public boolean has(long index) { return BlockOpenHashIndexedLong2ObjMap.this.has(index); }
            public Value get(long index) { return BlockOpenHashIndexedLong2ObjMap.this.getValue(index); }
            public Index indexes() { return BlockOpenHashIndexedLong2ObjMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return BlockOpenHashIndexedLong2ObjMap.this.iterateIndexes(); }
     ...
     */
    @SuppressWarnings("unchecked")
    public BlockOpenHashIndexedLong2ObjMap<Value> clone() {
        BlockOpenHashIndexedLong2ObjMap<Value> c;
        try {
            c=(BlockOpenHashIndexedLong2ObjMap<Value>) super.clone();
        }
    ...
    public boolean equals(Object o) {
        if(o instanceof IndexedLong2ObjMap) {
            IndexedLong2ObjMap that=(IndexedLong2ObjMap) o;
