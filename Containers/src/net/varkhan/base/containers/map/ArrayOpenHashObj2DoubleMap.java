 ...
 * @time 9:43:13 PM
 */
public class ArrayOpenHashObj2DoubleMap<Key> implements Obj2DoubleMap<Key>, Serializable, Cloneable {
     ...
     */
    public ArrayOpenHashObj2DoubleMap(long size, float loadfact, float growfact, final HashingStrategy<Key> strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
        ...
        this.vals=new double[this.capa];
    }
...
//        vals[slot]=0;
    ...
    public Iterator<Obj2DoubleMap.Entry<Key>> iterator() {
        return new Iterator<Obj2DoubleMap.Entry<Key>>() {
            ...
            {
                Object k;
                if(c!=0) while(pos<ArrayOpenHashObj2DoubleMap.this.capa&&((k=keys[pos])==NULL||k==DEL)) pos++;
            }

            public boolean hasNext() {
                return c!=0&&pos<ArrayOpenHashObj2DoubleMap.this.capa;
            }
            ...
            public Obj2DoubleMap.Entry<Key> next() {
                ...
                double val=vals[pos];
                Object k;
                if(--c!=0) do pos++; while(pos<ArrayOpenHashObj2DoubleMap.this.capa&&((k=keys[pos])==NULL||k==DEL));
...
//                vals[last]=0;
     ...
     */
    @SuppressWarnings("unchecked")
    public ArrayOpenHashObj2DoubleMap<Key> clone() {
        ArrayOpenHashObj2DoubleMap<Key> c;
        try {
            c=(ArrayOpenHashObj2DoubleMap<Key>) super.clone();
        }
