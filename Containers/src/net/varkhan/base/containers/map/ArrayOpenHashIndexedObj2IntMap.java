...
public class ArrayOpenHashIndexedObj2IntMap<Key> implements IndexedObj2IntMap<Key>, Serializable, Cloneable {
     ...
     */
    public ArrayOpenHashIndexedObj2IntMap(long size, float loadfact, float growfact, final HashingStrategy<Key> strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
    ...
    public void setValue(long index, Integer value) {
        ...
        else this.vals[(int) index]=value.intValue();
    }
...
//            } while( sidx<0 || (sidx>0 && ! (strategy.hash((Key)(kval=getKey(sidx-1)))==hash && strategy.equal((Key)key, (Key)kval) )) );
    ...
    private class Entry implements IndexedObj2IntMap.Entry<Key> {
        ...
        public Integer getValue() { return vals[idx]; }

        public int getIntValue() { return vals[idx]; }

        public Integer setValue(Integer val) {
            int old=vals[idx];
            if(val==null) vals[idx]=defVal;
            else vals[idx]=val.intValue();
            return old;
        }
    ...
    public Index indexes() {
        return new Index() {
            ...
            int c=ArrayOpenHashIndexedObj2IntMap.this.size;
            ...
            public boolean hasNext() {
                ...
                if(next==-1) {
                    next=curr+1;
                    while(next<ArrayOpenHashIndexedObj2IntMap.this.capa&&idxs[next]<=0) next++;
                }
                return next<ArrayOpenHashIndexedObj2IntMap.this.capa;
            }
            ...
            public boolean hasPrevious() {
                if(c==ArrayOpenHashIndexedObj2IntMap.this.size) return false;
                if(last==-1) {
                    last=curr-1;
        ...
        return new java.lang.Iterable<Long>() {
            public java.util.Iterator<Long> iterator() {
                return new java.util.Iterator<Long>() {
                    ...
                    {
                        if(c!=0) while(pos<ArrayOpenHashIndexedObj2IntMap.this.capa&&idxs[pos]<=0) pos++;
                    }

                    public boolean hasNext() {
                        return c!=0&&pos<ArrayOpenHashIndexedObj2IntMap.this.capa;
                    }

                    public Long next() {
                        if(!hasNext()) throw new NoSuchElementException();
                        int idx=idxs[(last=pos)]-1;
                        if(--c!=0) do pos++; while(pos<ArrayOpenHashIndexedObj2IntMap.this.capa&&idxs[pos]<=0);
                        return (long) idx;
                    }
    ...
    public IndexedContainer<Key> keys() {
        return new IndexedContainer<Key>() {
            public long size() { return ArrayOpenHashIndexedObj2IntMap.this.size(); }
            public boolean isEmpty() { return ArrayOpenHashIndexedObj2IntMap.this.isEmpty(); }
            public long head() { return ArrayOpenHashIndexedObj2IntMap.this.head(); }
            public boolean has(long index) { return ArrayOpenHashIndexedObj2IntMap.this.has(index); }
            public Key get(long index) { return ArrayOpenHashIndexedObj2IntMap.this.getKey(index); }
            public Index indexes() { return ArrayOpenHashIndexedObj2IntMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedObj2IntMap.this.iterateIndexes(); }
...
//                                vals[last]=0;
    ...
    public IndexedIntContainer values() {
        return new IndexedIntContainer() {
            ...
            public boolean isEmpty() { return ArrayOpenHashIndexedObj2IntMap.this.isEmpty(); }
            public long head() { return ArrayOpenHashIndexedObj2IntMap.this.head(); }
            public int getDefaultValue() {  return ArrayOpenHashIndexedObj2IntMap.this.getDefaultValue(); }
            public boolean has(long index) { return ArrayOpenHashIndexedObj2IntMap.this.has(index); }
            public Integer get(long index) { return ArrayOpenHashIndexedObj2IntMap.this.getValue(index); }
            public int getInt(long index) { return ArrayOpenHashIndexedObj2IntMap.this.getIntValue(index); }
            public Index indexes() { return ArrayOpenHashIndexedObj2IntMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedObj2IntMap.this.iterateIndexes(); }
