...
public class ArrayOpenHashIndexedMap<Key,Value> implements IndexedMap<Key,Value>, Serializable {
     ...
     */
    public ArrayOpenHashIndexedMap(long size, float loadfact, float growfact, final HashingStrategy<Key> strategy) {
...
//            } while( sidx<0 || (sidx>0 && ! (strategy.hash((Key)(kval=getKey(sidx-1)))==hash && strategy.equal((Key)key, (Key)kval) )) );
    ...
    public Index indexes() {
        return new Index() {
            ...
            int c=ArrayOpenHashIndexedMap.this.size;
            ...
            public boolean hasNext() {
                ...
                if(next==-1) {
                    next=curr+1;
                    while(next<ArrayOpenHashIndexedMap.this.capa&&idxs[next]<=0) next++;
                }
                return next<ArrayOpenHashIndexedMap.this.capa;
            }
            ...
            public boolean hasPrevious() {
                if(c==ArrayOpenHashIndexedMap.this.size) return false;
                if(last==-1) {
                    last=curr-1;
        ...
        return new java.lang.Iterable<Long>() {
            public java.util.Iterator<Long> iterator() {
                return new java.util.Iterator<Long>() {
                    ...
                    {
                        if(c!=0) while(pos<ArrayOpenHashIndexedMap.this.capa&&idxs[pos]<=0) pos++;
                    }

                    public boolean hasNext() {
                        return c!=0&&pos<ArrayOpenHashIndexedMap.this.capa;
                    }

                    public Long next() {
                        if(!hasNext()) throw new NoSuchElementException();
                        int idx=idxs[(last=pos)]-1;
                        if(--c!=0) do pos++; while(pos<ArrayOpenHashIndexedMap.this.capa&&idxs[pos]<=0);
                        return (long) idx;
                    }
    ...
    public <Par> long visit(IndexedMapVisitor<Key,Value,Par> vis, Par par) {
        ...
        while(pos<capa) {
            ...
            idx --;
            @SuppressWarnings("unchecked")
            long r=vis.invoke(idx, (Key) keys[idx], (Value) vals[idx], par);
            if(r<0) return c;
            c+=r;
            pos++;
        }
    ...
    public IndexedContainer<Key> keys() {
        return new IndexedContainer<Key>() {
            public long size() { return ArrayOpenHashIndexedMap.this.size(); }
            public boolean isEmpty() { return ArrayOpenHashIndexedMap.this.isEmpty(); }
            public long head() { return ArrayOpenHashIndexedMap.this.head(); }
            public boolean has(long index) { return ArrayOpenHashIndexedMap.this.has(index); }
            public Key get(long index) { return ArrayOpenHashIndexedMap.this.getKey(index); }
            public Index indexes() { return ArrayOpenHashIndexedMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedMap.this.iterateIndexes(); }
    ...
    public IndexedContainer<Value> values() {
        return new IndexedContainer<Value>() {
            ...
            public long head() { return ArrayOpenHashIndexedMap.this.head(); }
            public boolean has(long index) { return ArrayOpenHashIndexedMap.this.has(index); }
            public Value get(long index) { return ArrayOpenHashIndexedMap.this.getValue(index); }
            public Index indexes() { return ArrayOpenHashIndexedMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedMap.this.iterateIndexes(); }
