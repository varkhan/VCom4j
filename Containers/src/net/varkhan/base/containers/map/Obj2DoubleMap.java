 ...
 * @time 3:24:43 AM
 */
public interface Obj2DoubleMap<Key> extends Map<Key,Double> {
     ...
     */
    public interface Entry<Key> extends Map.Entry<Key,Double> {
     ...
     */
    public Iterator<? extends Obj2DoubleMap.Entry<Key>> iterator();
