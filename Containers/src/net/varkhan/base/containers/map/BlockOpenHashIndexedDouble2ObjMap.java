 ...
 * @time 9:43:13 PM
 */
public class BlockOpenHashIndexedDouble2ObjMap<Value> implements IndexedDouble2ObjMap<Value>, Serializable, Cloneable {
     ...
     */
    public BlockOpenHashIndexedDouble2ObjMap(long size, int blockshift, float loadfact, float growfact, final DoubleHashingStrategy strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
     ...
     * @param size the expected number of elements in the map
     */
    public BlockOpenHashIndexedDouble2ObjMap(long size) {
     ...
     * Creates a new hash map.
     */
    public BlockOpenHashIndexedDouble2ObjMap() {
    ...
    private void _setEntry(long index, double k, Object v) {
        int kblockpos=(int) (index>>>this.blockshift);
        int kblockoff=(int) (index&this.blockmask);
        double[] kblock=this.keys[kblockpos];
        Object[] vblock=this.vals[kblockpos];
    ...
    public IndexedDouble2ObjMap.Entry<Value> get(long index) {
    ...
    public long add(IndexedMap.Entry<Double,Value> item) {
    ...
    public long add(final Double key, final Value val) {
        if(key==null) return -1;
...
//            } while( sidx<0 || (sidx>0 && ! (hash == this.strategy.hash((Key)(kval=getKey(sidx-1))) && this.strategy.equal(key, (Key)kval))) );
     ...
     */
    @SuppressWarnings("unchecked")
    private class Entry implements IndexedDouble2ObjMap.Entry<Value> {
        private final long   idx;
        private final double key;

        public Entry(long idx, double key) {
            this.idx=idx;
            this.key=key;
        }
    ...
    public Index indexes() {
        return new Index() {
            ...
            long c=BlockOpenHashIndexedDouble2ObjMap.this.size;
            ...
            public boolean hasNext() {
                ...
                if(next==-1) {
                    next=curr+1;
                    while(next<BlockOpenHashIndexedDouble2ObjMap.this.capa&&_getIndex(next)<=0) next++;
                }
                return next<BlockOpenHashIndexedDouble2ObjMap.this.capa;
            }
            ...
            public boolean hasPrevious() {
                if(c==BlockOpenHashIndexedDouble2ObjMap.this.size) return false;
                if(last==-1) {
                    last=curr-1;
        ...
        return new java.lang.Iterable<Long>() {
            public java.util.Iterator<Long> iterator() {
                return new java.util.Iterator<Long>() {
                    ...
                    {
                        if(c!=0) while(pos<BlockOpenHashIndexedDouble2ObjMap.this.capa&&_getIndex(pos)<=0) pos++;
                    }

                    public boolean hasNext() {
                        return c!=0&&pos<BlockOpenHashIndexedDouble2ObjMap.this.capa;
                    }

                    public Long next() {
                        if(!hasNext()) throw new NoSuchElementException();
                        long idx=_getIndex(last=pos)-1;
                        if(--c!=0) do pos++; while(pos<BlockOpenHashIndexedDouble2ObjMap.this.capa&&_getIndex(pos)<=0);
                        return idx;
                    }
    ...
    public Iterator<IndexedDouble2ObjMap.Entry<Value>> iterator() {
        return new Iterator<IndexedDouble2ObjMap.Entry<Value>>() {
            /** The position of the next entry to be returned. */
            long pos=0;
            /** The position of the last entry that has been returned. */
            long last=-1;
            ...
            public IndexedDouble2ObjMap.Entry<Value> next() {
                if(!hasNext()) throw new NoSuchElementException();
                long idx=_getIndex(last=pos)-1;
                if(--c!=0) do pos++; while(pos<BlockOpenHashIndexedDouble2ObjMap.this.capa&&_getIndex(pos)<=0);
    ...
    public <Par> long visit(Visitor<IndexedMap.Entry<Double,Value>,Par> vis, Par par) {
        long c=0;
        int pos=0;
        while(pos<capa) {
    ...
    public <Par> long visit(IndexedVisitor<IndexedMap.Entry<Double,Value>,Par> vis, Par par) {
        long c=0;
        int pos=0;
        while(pos<capa) {
            long idx=_getIndex(pos);
    ...
    public <Par> long visit(IndexedMapVisitor<Double,Value,Par> vis, Par par) {
        long c=0;
        int pos=0;
        while(pos<capa) {
            long idx=_getIndex(pos);
    ...
    public Iterable<IndexedDouble2ObjMap.Entry<Value>> iterate(final long[] indexes) {
        return new Iterable<IndexedDouble2ObjMap.Entry<Value>>() {
            public Iterator<IndexedDouble2ObjMap.Entry<Value>> iterator() {
                return new Iterator<IndexedDouble2ObjMap.Entry<Value>>() {
    ...
    public Iterable<IndexedDouble2ObjMap.Entry<Value>> iterate(final java.lang.Iterable<Long> indexes) {
        return new Iterable<IndexedDouble2ObjMap.Entry<Value>>() {
            public Iterator<IndexedDouble2ObjMap.Entry<Value>> iterator() {
                return new Iterator<IndexedDouble2ObjMap.Entry<Value>>() {
    ...
    public Iterable<IndexedDouble2ObjMap.Entry<Value>> iterate(final Indexable indexes) {
        return new Iterable<IndexedDouble2ObjMap.Entry<Value>>() {
            public Iterator<IndexedDouble2ObjMap.Entry<Value>> iterator() {
                return new Iterator<IndexedDouble2ObjMap.Entry<Value>>() {
                    /** An iterator over indexes */
    ...
    public IndexedDoubleContainer keys() {
        return new IndexedDoubleContainer() {
            public long size() { return BlockOpenHashIndexedDouble2ObjMap.this.size(); }
            public boolean isEmpty() { return BlockOpenHashIndexedDouble2ObjMap.this.isEmpty(); }
            public long head() { return BlockOpenHashIndexedDouble2ObjMap.this.head(); }
            public double getDefaultValue() { return BlockOpenHashIndexedDouble2ObjMap.this.getDefaultKey(); }
            public boolean has(long index) { return BlockOpenHashIndexedDouble2ObjMap.this.has(index); }
            public Double get(long index) { return BlockOpenHashIndexedDouble2ObjMap.this.getKey(index); }
            public double getDouble(long index) { return BlockOpenHashIndexedDouble2ObjMap.this.getDoubleKey(index); }
            public Index indexes() { return BlockOpenHashIndexedDouble2ObjMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return BlockOpenHashIndexedDouble2ObjMap.this.iterateIndexes(); }
    ...
    public IndexedContainer<Value> values() {
        return new IndexedContainer<Value>() {
            ...
            public long head() { return BlockOpenHashIndexedDouble2ObjMap.this.head(); }
            public boolean has(long index) { return BlockOpenHashIndexedDouble2ObjMap.this.has(index); }
            public Value get(long index) { return BlockOpenHashIndexedDouble2ObjMap.this.getValue(index); }
            public Index indexes() { return BlockOpenHashIndexedDouble2ObjMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return BlockOpenHashIndexedDouble2ObjMap.this.iterateIndexes(); }
     ...
     */
    @SuppressWarnings("unchecked")
    public BlockOpenHashIndexedDouble2ObjMap<Value> clone() {
        BlockOpenHashIndexedDouble2ObjMap<Value> c;
        try {
            c=(BlockOpenHashIndexedDouble2ObjMap<Value>) super.clone();
        }
    ...
    public boolean equals(Object o) {
        if(o instanceof IndexedDouble2ObjMap) {
            IndexedDouble2ObjMap that=(IndexedDouble2ObjMap) o;
