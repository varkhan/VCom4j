...
public class StaticLog<T> implements Log<T> {
     ...
     */
    public StaticLog(String ctx, String key, long lev, LogWriter<T> wrt) {
     ...
     */
    public StaticLog(String ctx, String key, long lev, LogWriter<T> wrt, Time tmr) {
        this.ctx=ctx;
        this.key=key;
        this.msk=lev;
        this.wrt=wrt;
