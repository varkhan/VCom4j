 ...
 * @time 5:44:48 AM
 */
public class BlockIndexedIntList extends AbstractBlockIndexedList implements IndexedIntList, Externalizable, Cloneable {
     ...
     */
    public BlockIndexedIntList(int blockshift, double growthfact) {
     ...
     */
    public BlockIndexedIntList(int blockshift, double growthfact, IndexedList<? extends Number> list) {
     ...
     * @param list the IndexedList to copy
     */
    public BlockIndexedIntList(IndexedList<? extends Number> list) {
        this();
        Index it=list.indexes();
        while(it.hasNext()) {
            long id=it.next();
     ...
     * @param list the IndexedList to copy
     */
    public BlockIndexedIntList(IndexedIntList list) {
        this();
        Index it=list.indexes();
        while(it.hasNext()) {
            long id=it.next();
    ...
    /**
     * Builds an BlockIndexedIntList from an array of numbers.
     *
    ...
    /**
     * Builds an BlockIndexedIntList from an array of ints.
     *
     * @param array the array to copy
     */
    ...
    public boolean has(long index) {
        ...
        int[] block=list[(int) (index>>>blockshift)];
        ...
        return new IntIterator() {
            ...
            public int nextValue() {
                ...
                while(index<head) {
                    ...
                    int val=list[blockpos][(int) (index&blockmask)];
    ...
    public <Par> long visit(Visitor<Integer,Par> vis, Par par) {
        ...
        while(i<head) {
            ...
            int obj=list[blockpos][(int) (i&blockmask)];
            if(obj!=defVal) {
    ...
    /**
     * Write an BlockIndexedIntList to a stream.
     *
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        if(head>0) {
            ...
            for(int i=0;i<headlen;i++) {
                ...
                if(block==null) for(int j=0;j<blocksize;j++) out.writeInt(defVal);
                else for(int j=0;j<blocksize;j++) out.writeInt(block[j]);
            }
        }
    }
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        if(head>0) {
            ...
            for(int i=0;i<headlen;i++) {
                bits[i]=in.readInt();
                final int[] block=list[i]=new int[blocksize];
                for(int j=0;j<blocksize;j++) block[j]=in.readInt();
            }
        }
    }
    ...
    public boolean equals(Object obj) {
        if(!(obj instanceof BlockIndexedIntList)) return false;
        BlockIndexedIntList that=(BlockIndexedIntList) obj;
    ...
    public BlockIndexedIntList clone() {
        BlockIndexedIntList clone;
        try { clone=(BlockIndexedIntList) super.clone(); }
