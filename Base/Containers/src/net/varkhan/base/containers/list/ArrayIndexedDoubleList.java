 ...
 * @time 5:44:48 AM
 */
public class ArrayIndexedDoubleList implements IndexedDoubleList, Externalizable, Cloneable {
    ...
    public Double get(long index) {
        ...
        final double val=list[(int) index];
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        if(head>0) {
            list=new double[(int) head];
            for(int i=0;i<head;i++) {
                list[i]=in.readDouble();
            }
        }
    }
    ...
    public int hashCode() {
        ...
        if(head>0) {
            for(int i=0;i<head;i++) {
                long bits=Double.doubleToLongBits(list[i]);
    ...
    public boolean equals(Object obj) {
        if(!(obj instanceof ArrayIndexedDoubleList)) return false;
        ArrayIndexedDoubleList that=(ArrayIndexedDoubleList) obj;
    ...
    public ArrayIndexedDoubleList clone() {
        ArrayIndexedDoubleList clone;
        try { clone=(ArrayIndexedDoubleList) super.clone(); }
