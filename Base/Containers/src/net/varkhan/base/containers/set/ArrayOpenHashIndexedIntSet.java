 ...
 * @time 9:43:13 PM
 */
public class ArrayOpenHashIndexedIntSet implements IndexedIntSet, Serializable, Cloneable {
     ...
     */
    public ArrayOpenHashIndexedIntSet(long size, float loadfact, float growfact, final IntHashingStrategy strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
     ...
     * @param size the expected number of elements in the set
     */
    public ArrayOpenHashIndexedIntSet(long size) {
     ...
     * Creates a new hash set.
     */
    public ArrayOpenHashIndexedIntSet() {
...
//            } while( sidx<0 || (sidx>0 && ! (strategy.hash((Key)(kval=getKey(sidx-1)))==hash && strategy.equal((Key)key, (Key)kval) )) );
    ...
    public Index indexes() {
        return new Index() {
            ...
            int c=ArrayOpenHashIndexedIntSet.this.size;
            ...
            public boolean hasNext() {
                ...
                if(next==-1) {
                    next=curr+1;
                    while(next<ArrayOpenHashIndexedIntSet.this.capa&&idxs[next]<=0) next++;
                }
                return next<ArrayOpenHashIndexedIntSet.this.capa;
            }
            ...
            public boolean hasPrevious() {
                if(c==ArrayOpenHashIndexedIntSet.this.size) return false;
                if(last==-1) {
                    last=curr-1;
        ...
        return new java.lang.Iterable<Long>() {
            public java.util.Iterator<Long> iterator() {
                return new java.util.Iterator<Long>() {
                    ...
                    {
                        if(c!=0) while(pos<ArrayOpenHashIndexedIntSet.this.capa&&idxs[pos]<=0) pos++;
                    }

                    public boolean hasNext() {
                        return c!=0&&pos<ArrayOpenHashIndexedIntSet.this.capa;
                    }

                    public Long next() {
                        if(!hasNext()) throw new NoSuchElementException();
                        int idx=idxs[(last=pos)]-1;
                        if(--c!=0) do pos++; while(pos<ArrayOpenHashIndexedIntSet.this.capa&&idxs[pos]<=0);
                        return (long) idx;
                    }
    ...
    /**
     * The base IntEntry object for this set
     */
            ...
            public Iterator<IndexedIntSet.IntEntry> iterator() {
                return new Iterator<IndexedIntSet.IntEntry>() {
                    ...
                    public IndexedIntSet.IntEntry next() {
                        ...
                        int idx=idxs[(last=pos)]-1;
                        if(--c!=0) do pos++; while(pos<ArrayOpenHashIndexedIntSet.this.capa&&idxs[pos]<=0);
                        return new IntEntry(idx, keys[idx]);
                    }
     ...
     */
    public ArrayOpenHashIndexedIntSet clone() {
        ArrayOpenHashIndexedIntSet c;
        try {
            c=(ArrayOpenHashIndexedIntSet) super.clone();
        }
