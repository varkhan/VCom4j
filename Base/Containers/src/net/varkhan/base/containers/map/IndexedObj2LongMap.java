 ...
 * @time 3:37:27 AM
 */
public interface IndexedObj2LongMap<Key> extends IndexedMap<Key,Long> {
     ...
     */
    public interface Entry<Key> extends IndexedMap.Entry<Key,Long> {
     ...
     */
    public long add(Key key, long val);
     ...
     */
    public Iterator<? extends IndexedObj2LongMap.Entry<Key>> iterator();
     ...
     */
    public Iterable<? extends IndexedObj2LongMap.Entry<Key>> iterate(long[] indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedObj2LongMap.Entry<Key>> iterate(java.lang.Iterable<Long> indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedObj2LongMap.Entry<Key>> iterate(Indexable indexes);
