 ...
 * @time 3:37:27 AM
 */
public interface IndexedFloat2ObjMap<Value> extends IndexedMap<Float,Value> {
     ...
     */
    public interface Entry<Value> extends IndexedMap.Entry<Float,Value> {
     ...
     */
    public long add(float key, Value val);
     ...
     */
    public Iterator<? extends IndexedFloat2ObjMap.Entry<Value>> iterator();
     ...
     */
    public Iterable<? extends IndexedFloat2ObjMap.Entry<Value>> iterate(long[] indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedFloat2ObjMap.Entry<Value>> iterate(java.lang.Iterable<Long> indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedFloat2ObjMap.Entry<Value>> iterate(Indexable indexes);
