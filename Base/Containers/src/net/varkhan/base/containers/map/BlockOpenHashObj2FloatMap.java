...
public class BlockOpenHashObj2FloatMap<Key> implements Obj2FloatMap<Key>, Serializable, Cloneable {
     ...
     */
    public BlockOpenHashObj2FloatMap(long size, int blockshift, float loadfact, float growfact, final HashingStrategy<Key> strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
    ...
    public Iterator<Obj2FloatMap.Entry<Key>> iterator() {
        return new Iterator<Obj2FloatMap.Entry<Key>>() {
            ...
            {
                Object k;
                if(c!=0) while(pos<BlockOpenHashObj2FloatMap.this.capa&&((k=_getKey(pos))==NULL||k==DEL)) pos++;
            }

            public boolean hasNext() {
                return c!=0&&pos<BlockOpenHashObj2FloatMap.this.capa;
            }
            ...
            public Obj2FloatMap.Entry<Key> next() {
                ...
                Object k;
                if(--c!=0) do pos++; while(pos<BlockOpenHashObj2FloatMap.this.capa&&((k=_getKey(pos))==NULL||k==DEL));
