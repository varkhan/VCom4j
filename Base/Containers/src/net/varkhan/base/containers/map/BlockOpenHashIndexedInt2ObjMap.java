 ...
 * @time 9:43:13 PM
 */
public class BlockOpenHashIndexedInt2ObjMap<Value> implements IndexedInt2ObjMap<Value>, Serializable, Cloneable {
     ...
     */
    public BlockOpenHashIndexedInt2ObjMap(long size, int blockshift, float loadfact, float growfact, final IntHashingStrategy strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
     ...
     * @param size the expected number of elements in the map
     */
    public BlockOpenHashIndexedInt2ObjMap(long size) {
        this(size, 10, .75f, 1.5f, IntHashingStrategy.DefaultHashingStrategy);
    }

    /**
     * Creates a new hash map.
     */
    public BlockOpenHashIndexedInt2ObjMap() {
        this(11, 10, .75f, 1.5f, IntHashingStrategy.DefaultHashingStrategy);
    }
    ...
    private void _setEntry(long index, int k, Object v) {
        int kblockpos=(int) (index>>>this.blockshift);
        int kblockoff=(int) (index&this.blockmask);
        int[] kblock=this.keys[kblockpos];
        Object[] vblock=this.vals[kblockpos];
        byte[] fblock=this.flgs[kblockpos];
        if(kblock==null) this.keys[kblockpos]=kblock=new int[this.blocksize];
        if(vblock==null) this.vals[kblockpos]=vblock=new Object[this.blocksize];
...
//            } while( sidx<0 || (sidx>0 && ! (hash == this.strategy.hash((Key)(kval=getKey(sidx-1))) && this.strategy.equal(key, (Key)kval))) );
    ...
    public Index indexes() {
        return new Index() {
            ...
            long c=BlockOpenHashIndexedInt2ObjMap.this.size;
            ...
            public boolean hasNext() {
                ...
                if(next==-1) {
                    next=curr+1;
                    while(next<BlockOpenHashIndexedInt2ObjMap.this.capa&&_getIndex(next)<=0) next++;
                }
                return next<BlockOpenHashIndexedInt2ObjMap.this.capa;
            }
            ...
            public boolean hasPrevious() {
                if(c==BlockOpenHashIndexedInt2ObjMap.this.size) return false;
                if(last==-1) {
                    last=curr-1;
        ...
        return new java.lang.Iterable<Long>() {
            public java.util.Iterator<Long> iterator() {
                return new java.util.Iterator<Long>() {
                    ...
                    {
                        if(c!=0) while(pos<BlockOpenHashIndexedInt2ObjMap.this.capa&&_getIndex(pos)<=0) pos++;
                    }

                    public boolean hasNext() {
                        return c!=0&&pos<BlockOpenHashIndexedInt2ObjMap.this.capa;
                    }

                    public Long next() {
                        if(!hasNext()) throw new NoSuchElementException();
                        long idx=_getIndex(last=pos)-1;
                        if(--c!=0) do pos++; while(pos<BlockOpenHashIndexedInt2ObjMap.this.capa&&_getIndex(pos)<=0);
                        return idx;
                    }
    ...
    public IndexedIntContainer keys() {
        return new IndexedIntContainer() {
            public long size() { return BlockOpenHashIndexedInt2ObjMap.this.size(); }
            public boolean isEmpty() { return BlockOpenHashIndexedInt2ObjMap.this.isEmpty(); }
            public long head() { return BlockOpenHashIndexedInt2ObjMap.this.head(); }
            public int getDefaultValue() { return BlockOpenHashIndexedInt2ObjMap.this.getDefaultKey(); }
            public boolean has(long index) { return BlockOpenHashIndexedInt2ObjMap.this.has(index); }
            public Integer get(long index) { return BlockOpenHashIndexedInt2ObjMap.this.getKey(index); }
            public int getInt(long index) { return BlockOpenHashIndexedInt2ObjMap.this.getIntKey(index); }
            public Index indexes() { return BlockOpenHashIndexedInt2ObjMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return BlockOpenHashIndexedInt2ObjMap.this.iterateIndexes(); }
    ...
    public IndexedContainer<Value> values() {
        return new IndexedContainer<Value>() {
            ...
            public long head() { return BlockOpenHashIndexedInt2ObjMap.this.head(); }
            public boolean has(long index) { return BlockOpenHashIndexedInt2ObjMap.this.has(index); }
            public Value get(long index) { return BlockOpenHashIndexedInt2ObjMap.this.getValue(index); }
            public Index indexes() { return BlockOpenHashIndexedInt2ObjMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return BlockOpenHashIndexedInt2ObjMap.this.iterateIndexes(); }
     ...
     */
    @SuppressWarnings("unchecked")
    public BlockOpenHashIndexedInt2ObjMap<Value> clone() {
        BlockOpenHashIndexedInt2ObjMap<Value> c;
        try {
            c=(BlockOpenHashIndexedInt2ObjMap<Value>) super.clone();
        }
