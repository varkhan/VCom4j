 ...
 * @time 9:43:13 PM
 */
public class ArrayOpenHashIndexedLong2ObjMap<Value> implements IndexedLong2ObjMap<Value>, Serializable, Cloneable {
     ...
     */
    public ArrayOpenHashIndexedLong2ObjMap(long size, float loadfact, float growfact, final LongHashingStrategy strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
     ...
     * @param size the expected number of elements in the set
     */
    public ArrayOpenHashIndexedLong2ObjMap(long size) {
     ...
     * Creates a new hash set.
     */
    public ArrayOpenHashIndexedLong2ObjMap() {
...
//            } while( sidx<0 || (sidx>0 && ! (strategy.hash((Key)(kval=getKey(sidx-1)))==hash && strategy.equal((Key)key, (Key)kval) )) );
    ...
    public Index indexes() {
        return new Index() {
            ...
            int c=ArrayOpenHashIndexedLong2ObjMap.this.size;
            ...
            public boolean hasNext() {
                ...
                if(next==-1) {
                    next=curr+1;
                    while(next<ArrayOpenHashIndexedLong2ObjMap.this.capa&&idxs[next]<=0) next++;
                }
                return next<ArrayOpenHashIndexedLong2ObjMap.this.capa;
            }
            ...
            public boolean hasPrevious() {
                if(c==ArrayOpenHashIndexedLong2ObjMap.this.size) return false;
                if(last==-1) {
                    last=curr-1;
        ...
        return new java.lang.Iterable<Long>() {
            public java.util.Iterator<Long> iterator() {
                return new java.util.Iterator<Long>() {
                    ...
                    {
                        if(c!=0) while(pos<ArrayOpenHashIndexedLong2ObjMap.this.capa&&idxs[pos]<=0) pos++;
                    }

                    public boolean hasNext() {
                        return c!=0&&pos<ArrayOpenHashIndexedLong2ObjMap.this.capa;
                    }

                    public Long next() {
                        if(!hasNext()) throw new NoSuchElementException();
                        int idx=idxs[(last=pos)]-1;
                        if(--c!=0) do pos++; while(pos<ArrayOpenHashIndexedLong2ObjMap.this.capa&&idxs[pos]<=0);
                        return (long) idx;
                    }
    ...
    public IndexedLongContainer keys() {
        return new IndexedLongContainer() {
            public long size() { return ArrayOpenHashIndexedLong2ObjMap.this.size(); }
            public boolean isEmpty() { return ArrayOpenHashIndexedLong2ObjMap.this.isEmpty(); }
            public long head() { return ArrayOpenHashIndexedLong2ObjMap.this.head(); }
            public long getDefaultValue() {  return ArrayOpenHashIndexedLong2ObjMap.this.getDefaultKey(); }
            public boolean has(long index) { return ArrayOpenHashIndexedLong2ObjMap.this.has(index); }
            public Long get(long index) { return ArrayOpenHashIndexedLong2ObjMap.this.getKey(index); }
            public long getLong(long index) { return ArrayOpenHashIndexedLong2ObjMap.this.getLongKey(index); }
            public Index indexes() { return ArrayOpenHashIndexedLong2ObjMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedLong2ObjMap.this.iterateIndexes(); }
...
//                                keys[last]=0;
    ...
    public IndexedContainer<Value> values() {
        return new IndexedContainer<Value>() {
            ...
            public long head() { return ArrayOpenHashIndexedLong2ObjMap.this.head(); }
            public boolean has(long index) { return ArrayOpenHashIndexedLong2ObjMap.this.has(index); }
            public Value get(long index) { return ArrayOpenHashIndexedLong2ObjMap.this.getValue(index); }
            public Index indexes() { return ArrayOpenHashIndexedLong2ObjMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedLong2ObjMap.this.iterateIndexes(); }
...
//                                keys[last]=0;
     ...
     */
    @SuppressWarnings("unchecked")
    public ArrayOpenHashIndexedLong2ObjMap<Value> clone() {
        ArrayOpenHashIndexedLong2ObjMap<Value> c;
        try {
            c=(ArrayOpenHashIndexedLong2ObjMap<Value>) super.clone();
        }
