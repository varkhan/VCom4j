...
public class ArrayOpenHashIndexedObj2LongMap<Key> implements IndexedObj2LongMap<Key>, Serializable, Cloneable {
     ...
     */
    public ArrayOpenHashIndexedObj2LongMap(long size, float loadfact, float growfact, final HashingStrategy<Key> strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
    ...
    public void setValue(long index, Long value) {
        ...
        else this.vals[(int) index]=value.longValue();
    }
...
//            } while( sidx<0 || (sidx>0 && ! (strategy.hash((Key)(kval=getKey(sidx-1)))==hash && strategy.equal((Key)key, (Key)kval) )) );
    ...
    private class Entry implements IndexedObj2LongMap.Entry<Key> {
        ...
        public Long getValue() { return vals[idx]; }

        public long getLongValue() { return vals[idx]; }

        public Long setValue(Long val) {
            long old=vals[idx];
            if(val==null) vals[idx]=defVal;
            else vals[idx]=val.longValue();
            return old;
        }
    ...
    public Index indexes() {
        return new Index() {
            ...
            int c=ArrayOpenHashIndexedObj2LongMap.this.size;
            ...
            public boolean hasNext() {
                ...
                if(next==-1) {
                    next=curr+1;
                    while(next<ArrayOpenHashIndexedObj2LongMap.this.capa&&idxs[next]<=0) next++;
                }
                return next<ArrayOpenHashIndexedObj2LongMap.this.capa;
            }
            ...
            public boolean hasPrevious() {
                if(c==ArrayOpenHashIndexedObj2LongMap.this.size) return false;
                if(last==-1) {
                    last=curr-1;
        ...
        return new java.lang.Iterable<Long>() {
            public java.util.Iterator<Long> iterator() {
                return new java.util.Iterator<Long>() {
                    ...
                    {
                        if(c!=0) while(pos<ArrayOpenHashIndexedObj2LongMap.this.capa&&idxs[pos]<=0) pos++;
                    }

                    public boolean hasNext() {
                        return c!=0&&pos<ArrayOpenHashIndexedObj2LongMap.this.capa;
                    }

                    public Long next() {
                        if(!hasNext()) throw new NoSuchElementException();
                        int idx=idxs[(last=pos)]-1;
                        if(--c!=0) do pos++; while(pos<ArrayOpenHashIndexedObj2LongMap.this.capa&&idxs[pos]<=0);
                        return (long) idx;
                    }
    ...
    public IndexedContainer<Key> keys() {
        return new IndexedContainer<Key>() {
            public long size() { return ArrayOpenHashIndexedObj2LongMap.this.size(); }
            public boolean isEmpty() { return ArrayOpenHashIndexedObj2LongMap.this.isEmpty(); }
            public long head() { return ArrayOpenHashIndexedObj2LongMap.this.head(); }
            public boolean has(long index) { return ArrayOpenHashIndexedObj2LongMap.this.has(index); }
            public Key get(long index) { return ArrayOpenHashIndexedObj2LongMap.this.getKey(index); }
            public Index indexes() { return ArrayOpenHashIndexedObj2LongMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedObj2LongMap.this.iterateIndexes(); }
...
//                                vals[last]=0;
    ...
    public IndexedLongContainer values() {
        return new IndexedLongContainer() {
            ...
            public boolean isEmpty() { return ArrayOpenHashIndexedObj2LongMap.this.isEmpty(); }
            public long head() { return ArrayOpenHashIndexedObj2LongMap.this.head(); }
            public long getDefaultValue() {  return ArrayOpenHashIndexedObj2LongMap.this.getDefaultValue(); }
            public boolean has(long index) { return ArrayOpenHashIndexedObj2LongMap.this.has(index); }
            public Long get(long index) { return ArrayOpenHashIndexedObj2LongMap.this.getValue(index); }
            public long getLong(long index) { return ArrayOpenHashIndexedObj2LongMap.this.getLongValue(index); }
            public Index indexes() { return ArrayOpenHashIndexedObj2LongMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedObj2LongMap.this.iterateIndexes(); }
