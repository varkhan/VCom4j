 ...
 * @time 3:37:27 AM
 */
public interface IndexedObj2IntMap<Key> extends IndexedMap<Key,Integer> {
     ...
     */
    public interface Entry<Key> extends IndexedMap.Entry<Key,Integer> {
     ...
     */
    public long add(Key key, int val);
     ...
     */
    public Iterator<? extends IndexedObj2IntMap.Entry<Key>> iterator();
     ...
     */
    public Iterable<? extends IndexedObj2IntMap.Entry<Key>> iterate(long[] indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedObj2IntMap.Entry<Key>> iterate(java.lang.Iterable<Long> indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedObj2IntMap.Entry<Key>> iterate(Indexable indexes);
