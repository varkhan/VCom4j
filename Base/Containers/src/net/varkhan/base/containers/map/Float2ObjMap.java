 ...
 * @time 3:24:43 AM
 */
public interface Float2ObjMap<Value> extends Map<Float,Value> {
     ...
     */
    public interface Entry<Value> extends Map.Entry<Float,Value> {
     ...
     */
    public boolean add(Float2ObjMap.Entry<Value> item);
     ...
     *         instance, because the key is already present, with the same value)
     */
    public boolean add(float key, Value val);
     ...
     */
    public Iterator<? extends Float2ObjMap.Entry<Value>> iterator();
