 ...
 * @time 3:24:43 AM
 */
public interface Long2ObjMap<Value> extends Map<Long,Value> {
     ...
     */
    public interface Entry<Value> extends Map.Entry<Long,Value> {
     ...
     */
    public Iterator<? extends Long2ObjMap.Entry<Value>> iterator();
