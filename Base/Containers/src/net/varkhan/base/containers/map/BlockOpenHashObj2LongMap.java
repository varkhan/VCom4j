...
public class BlockOpenHashObj2LongMap<Key> implements Obj2LongMap<Key>, Serializable, Cloneable {
     ...
     */
    public BlockOpenHashObj2LongMap(long size, int blockshift, float loadfact, float growfact, final HashingStrategy<Key> strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
    ...
    public BlockOpenHashObj2LongMap(long size) {
     ...
     */
    @SuppressWarnings("unchecked")
    public BlockOpenHashObj2LongMap() {
    ...
    public Iterator<Obj2LongMap.Entry<Key>> iterator() {
        return new Iterator<Obj2LongMap.Entry<Key>>() {
            ...
            {
                Object k;
                if(c!=0) while(pos<BlockOpenHashObj2LongMap.this.capa&&((k=_getKey(pos))==NULL||k==DEL)) pos++;
            }

            public boolean hasNext() {
                return c!=0&&pos<BlockOpenHashObj2LongMap.this.capa;
            }
            ...
            public Obj2LongMap.Entry<Key> next() {
                ...
                Object k;
                if(--c!=0) do pos++; while(pos<BlockOpenHashObj2LongMap.this.capa&&((k=_getKey(pos))==NULL||k==DEL));
