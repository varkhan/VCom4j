 ...
 * @time 3:24:43 AM
 */
public interface Obj2LongMap<Key> extends Map<Key,Long> {
     ...
     */
    public interface Entry<Key> extends Map.Entry<Key,Long> {
     ...
     */
    public Iterator<? extends Obj2LongMap.Entry<Key>> iterator();
