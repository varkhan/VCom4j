 ...
 * @time 9:43:13 PM
 */
public class ArrayOpenHashIndexedLong2FloatMap implements IndexedLong2FloatMap, Serializable, Cloneable {
     ...
     */
    public ArrayOpenHashIndexedLong2FloatMap(long size, float loadfact, float growfact, final LongHashingStrategy strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
     ...
     * @param size the expected number of elements in the set
     */
    public ArrayOpenHashIndexedLong2FloatMap(long size) {
     ...
     * Creates a new hash set.
     */
    public ArrayOpenHashIndexedLong2FloatMap() {
...
//            } while( sidx<0 || (sidx>0 && ! (strategy.hash((Key)(kval=getKey(sidx-1)))==hash && strategy.equal((Key)key, (Key)kval) )) );
    ...
    public Index indexes() {
        return new Index() {
            ...
            int c=ArrayOpenHashIndexedLong2FloatMap.this.size;
            ...
            public boolean hasNext() {
                ...
                if(next==-1) {
                    next=curr+1;
                    while(next<ArrayOpenHashIndexedLong2FloatMap.this.capa&&idxs[next]<=0) next++;
                }
                return next<ArrayOpenHashIndexedLong2FloatMap.this.capa;
            }
            ...
            public boolean hasPrevious() {
                if(c==ArrayOpenHashIndexedLong2FloatMap.this.size) return false;
                if(last==-1) {
                    last=curr-1;
        ...
        return new java.lang.Iterable<Long>() {
            public java.util.Iterator<Long> iterator() {
                return new java.util.Iterator<Long>() {
                    ...
                    {
                        if(c!=0) while(pos<ArrayOpenHashIndexedLong2FloatMap.this.capa&&idxs[pos]<=0) pos++;
                    }

                    public boolean hasNext() {
                        return c!=0&&pos<ArrayOpenHashIndexedLong2FloatMap.this.capa;
                    }

                    public Long next() {
                        if(!hasNext()) throw new NoSuchElementException();
                        int idx=idxs[(last=pos)]-1;
                        if(--c!=0) do pos++; while(pos<ArrayOpenHashIndexedLong2FloatMap.this.capa&&idxs[pos]<=0);
                        return (long) idx;
                    }
    ...
    public IndexedLongContainer keys() {
        return new IndexedLongContainer() {
            public long size() { return ArrayOpenHashIndexedLong2FloatMap.this.size(); }
            public boolean isEmpty() { return ArrayOpenHashIndexedLong2FloatMap.this.isEmpty(); }
            public long head() { return ArrayOpenHashIndexedLong2FloatMap.this.head(); }
            public long getDefaultValue() {  return ArrayOpenHashIndexedLong2FloatMap.this.getDefaultKey(); }
            public boolean has(long index) { return ArrayOpenHashIndexedLong2FloatMap.this.has(index); }
            public Long get(long index) { return ArrayOpenHashIndexedLong2FloatMap.this.getKey(index); }
            public long getLong(long index) { return ArrayOpenHashIndexedLong2FloatMap.this.getLongKey(index); }
            public Index indexes() { return ArrayOpenHashIndexedLong2FloatMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedLong2FloatMap.this.iterateIndexes(); }
...
//                                vals[last]=0;
    ...
    public IndexedFloatContainer values() {
        return new IndexedFloatContainer() {
            ...
            public boolean isEmpty() { return ArrayOpenHashIndexedLong2FloatMap.this.isEmpty(); }
            public long head() { return ArrayOpenHashIndexedLong2FloatMap.this.head(); }
            public float getDefaultValue() {  return ArrayOpenHashIndexedLong2FloatMap.this.getDefaultValue(); }
            public boolean has(long index) { return ArrayOpenHashIndexedLong2FloatMap.this.has(index); }
            public Float get(long index) { return ArrayOpenHashIndexedLong2FloatMap.this.getValue(index); }
            public float getFloat(long index) { return ArrayOpenHashIndexedLong2FloatMap.this.getFloatValue(index); }
            public Index indexes() { return ArrayOpenHashIndexedLong2FloatMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedLong2FloatMap.this.iterateIndexes(); }
...
//                                vals[last]=0;
     ...
     */
    public ArrayOpenHashIndexedLong2FloatMap clone() {
        ArrayOpenHashIndexedLong2FloatMap c;
        try {
            c=(ArrayOpenHashIndexedLong2FloatMap) super.clone();
        }
