 ...
 * @time 9:43:13 PM
 */
public class ArrayOpenHashIndexedObj2FloatMap<Key> implements IndexedObj2FloatMap<Key>, Serializable, Cloneable {
     ...
     */
    public ArrayOpenHashIndexedObj2FloatMap(long size, float loadfact, float growfact, final HashingStrategy<Key> strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
    ...
    public long add(IndexedMap.Entry<Key,Float> item) {
    ...
    public long add(IndexedObj2FloatMap.Entry<Key> item) {
        if(item==null) return -1;
        return add(item.getKey(), item.getFloatValue());
    }

    public long add(final Key key, final Float val) {
...
//            } while( sidx<0 || (sidx>0 && ! (strategy.hash((Key)(kval=getKey(sidx-1)))==hash && strategy.equal((Key)key, (Key)kval) )) );
     ...
     */
    private class Entry implements IndexedObj2FloatMap.Entry<Key> {
    ...
    public Index indexes() {
        return new Index() {
            ...
            int c=ArrayOpenHashIndexedObj2FloatMap.this.size;
            ...
            public boolean hasNext() {
                ...
                if(next==-1) {
                    next=curr+1;
                    while(next<ArrayOpenHashIndexedObj2FloatMap.this.capa&&idxs[next]<=0) next++;
                }
                return next<ArrayOpenHashIndexedObj2FloatMap.this.capa;
            }
            ...
            public boolean hasPrevious() {
                if(c==ArrayOpenHashIndexedObj2FloatMap.this.size) return false;
                if(last==-1) {
                    last=curr-1;
        ...
        return new java.lang.Iterable<Long>() {
            public java.util.Iterator<Long> iterator() {
                return new java.util.Iterator<Long>() {
                    ...
                    {
                        if(c!=0) while(pos<ArrayOpenHashIndexedObj2FloatMap.this.capa&&idxs[pos]<=0) pos++;
                    }

                    public boolean hasNext() {
                        return c!=0&&pos<ArrayOpenHashIndexedObj2FloatMap.this.capa;
                    }

                    public Long next() {
                        if(!hasNext()) throw new NoSuchElementException();
                        int idx=idxs[(last=pos)]-1;
                        if(--c!=0) do pos++; while(pos<ArrayOpenHashIndexedObj2FloatMap.this.capa&&idxs[pos]<=0);
                        return (long) idx;
                    }
    ...
    public Iterator<IndexedObj2FloatMap.Entry<Key>> iterator() {
        return new Iterator<IndexedObj2FloatMap.Entry<Key>>() {
            /** The position of the next entry to be returned. */
            int pos=0;
            /** The position of the last entry that has been returned. */
            int last=-1;
            ...
            @SuppressWarnings("unchecked")
            public IndexedObj2FloatMap.Entry<Key> next() {
                if(!hasNext()) throw new NoSuchElementException();
    ...
    public <Par> long visit(Visitor<IndexedMap.Entry<Key,Float>,Par> vis, Par par) {
        long c=0;
        int pos=0;
        while(pos<capa) {
            int idx=idxs[pos];
    ...
    public <Par> long visit(IndexedVisitor<IndexedMap.Entry<Key,Float>,Par> vis, Par par) {
        long c=0;
        int pos=0;
        while(pos<capa) {
            int idx=idxs[pos];
    ...
    public <Par> long visit(IndexedMapVisitor<Key,Float,Par> vis, Par par) {
        long c=0;
        int pos=0;
        while(pos<capa) {
            int idx=idxs[pos];
    ...
    public Iterable<IndexedObj2FloatMap.Entry<Key>> iterate(final long[] indexes) {
        return new Iterable<IndexedObj2FloatMap.Entry<Key>>() {
            public Iterator<IndexedObj2FloatMap.Entry<Key>> iterator() {
                return new Iterator<IndexedObj2FloatMap.Entry<Key>>() {
    ...
    public Iterable<IndexedObj2FloatMap.Entry<Key>> iterate(final java.lang.Iterable<Long> indexes) {
        return new Iterable<IndexedObj2FloatMap.Entry<Key>>() {
            public Iterator<IndexedObj2FloatMap.Entry<Key>> iterator() {
                return new Iterator<IndexedObj2FloatMap.Entry<Key>>() {
    ...
    public Iterable<IndexedObj2FloatMap.Entry<Key>> iterate(final Indexable indexes) {
        return new Iterable<IndexedObj2FloatMap.Entry<Key>>() {
            public Iterator<IndexedObj2FloatMap.Entry<Key>> iterator() {
                return new Iterator<IndexedObj2FloatMap.Entry<Key>>() {
                    /** An iterator over indexes */
    ...
    public IndexedContainer<Key> keys() {
        return new IndexedContainer<Key>() {
            public long size() { return ArrayOpenHashIndexedObj2FloatMap.this.size(); }
            public boolean isEmpty() { return ArrayOpenHashIndexedObj2FloatMap.this.isEmpty(); }
            public long head() { return ArrayOpenHashIndexedObj2FloatMap.this.head(); }
            public boolean has(long index) { return ArrayOpenHashIndexedObj2FloatMap.this.has(index); }
            public Key get(long index) { return ArrayOpenHashIndexedObj2FloatMap.this.getKey(index); }
            public Index indexes() { return ArrayOpenHashIndexedObj2FloatMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedObj2FloatMap.this.iterateIndexes(); }
...
//                                vals[last]=0;
    ...
    public IndexedFloatContainer values() {
        return new IndexedFloatContainer() {
            ...
            public boolean isEmpty() { return ArrayOpenHashIndexedObj2FloatMap.this.isEmpty(); }
            public long head() { return ArrayOpenHashIndexedObj2FloatMap.this.head(); }
            public float getDefaultValue() {  return ArrayOpenHashIndexedObj2FloatMap.this.getDefaultValue(); }
            public boolean has(long index) { return ArrayOpenHashIndexedObj2FloatMap.this.has(index); }
            public Float get(long index) { return ArrayOpenHashIndexedObj2FloatMap.this.getValue(index); }
            public float getFloat(long index) { return ArrayOpenHashIndexedObj2FloatMap.this.getFloatValue(index); }
            public Index indexes() { return ArrayOpenHashIndexedObj2FloatMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedObj2FloatMap.this.iterateIndexes(); }
...
//                                vals[last]=0;
     ...
     */
    @SuppressWarnings("unchecked")
    public ArrayOpenHashIndexedObj2FloatMap<Key> clone() {
        ArrayOpenHashIndexedObj2FloatMap<Key> c;
        try {
            c=(ArrayOpenHashIndexedObj2FloatMap<Key>) super.clone();
        }
    ...
    public boolean equals(Object o) {
        if(o instanceof IndexedObj2FloatMap) {
            IndexedObj2FloatMap that=(IndexedObj2FloatMap) o;
