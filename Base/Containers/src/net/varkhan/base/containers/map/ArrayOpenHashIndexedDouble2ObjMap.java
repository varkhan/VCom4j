 ...
 * @time 9:43:13 PM
 */
public class ArrayOpenHashIndexedDouble2ObjMap<Value> implements IndexedDouble2ObjMap<Value>, Serializable, Cloneable {
     ...
     */
    public ArrayOpenHashIndexedDouble2ObjMap(long size, float loadfact, float growfact, final DoubleHashingStrategy strategy) {
...
//        if(size<0) throw new IllegalArgumentException("Hash table size must be nonnegative");
     ...
     * @param size the expected number of elements in the set
     */
    public ArrayOpenHashIndexedDouble2ObjMap(long size) {
     ...
     * Creates a new hash set.
     */
    public ArrayOpenHashIndexedDouble2ObjMap() {
...
//            } while( sidx<0 || (sidx>0 && ! (strategy.hash((Key)(kval=getKey(sidx-1)))==hash && strategy.equal((Key)key, (Key)kval) )) );
    ...
    public Index indexes() {
        return new Index() {
            ...
            int c=ArrayOpenHashIndexedDouble2ObjMap.this.size;
            ...
            public boolean hasNext() {
                ...
                if(next==-1) {
                    next=curr+1;
                    while(next<ArrayOpenHashIndexedDouble2ObjMap.this.capa&&idxs[next]<=0) next++;
                }
                return next<ArrayOpenHashIndexedDouble2ObjMap.this.capa;
            }
            ...
            public boolean hasPrevious() {
                if(c==ArrayOpenHashIndexedDouble2ObjMap.this.size) return false;
                if(last==-1) {
                    last=curr-1;
        ...
        return new java.lang.Iterable<Long>() {
            public java.util.Iterator<Long> iterator() {
                return new java.util.Iterator<Long>() {
                    ...
                    {
                        if(c!=0) while(pos<ArrayOpenHashIndexedDouble2ObjMap.this.capa&&idxs[pos]<=0) pos++;
                    }

                    public boolean hasNext() {
                        return c!=0&&pos<ArrayOpenHashIndexedDouble2ObjMap.this.capa;
                    }

                    public Long next() {
                        if(!hasNext()) throw new NoSuchElementException();
                        int idx=idxs[(last=pos)]-1;
                        if(--c!=0) do pos++; while(pos<ArrayOpenHashIndexedDouble2ObjMap.this.capa&&idxs[pos]<=0);
                        return (long) idx;
                    }
    ...
    public IndexedDoubleContainer keys() {
        return new IndexedDoubleContainer() {
            public long size() { return ArrayOpenHashIndexedDouble2ObjMap.this.size(); }
            public boolean isEmpty() { return ArrayOpenHashIndexedDouble2ObjMap.this.isEmpty(); }
            public long head() { return ArrayOpenHashIndexedDouble2ObjMap.this.head(); }
            public double getDefaultValue() {  return ArrayOpenHashIndexedDouble2ObjMap.this.getDefaultKey(); }
            public boolean has(long index) { return ArrayOpenHashIndexedDouble2ObjMap.this.has(index); }
            public Double get(long index) { return ArrayOpenHashIndexedDouble2ObjMap.this.getKey(index); }
            public double getDouble(long index) { return ArrayOpenHashIndexedDouble2ObjMap.this.getDoubleKey(index); }
            public Index indexes() { return ArrayOpenHashIndexedDouble2ObjMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedDouble2ObjMap.this.iterateIndexes(); }
...
//                                keys[last]=0;
    ...
    public IndexedContainer<Value> values() {
        return new IndexedContainer<Value>() {
            ...
            public long head() { return ArrayOpenHashIndexedDouble2ObjMap.this.head(); }
            public boolean has(long index) { return ArrayOpenHashIndexedDouble2ObjMap.this.has(index); }
            public Value get(long index) { return ArrayOpenHashIndexedDouble2ObjMap.this.getValue(index); }
            public Index indexes() { return ArrayOpenHashIndexedDouble2ObjMap.this.indexes(); }
            public java.lang.Iterable<Long> iterateIndexes() { return ArrayOpenHashIndexedDouble2ObjMap.this.iterateIndexes(); }
...
//                                keys[last]=0;
     ...
     */
    @SuppressWarnings("unchecked")
    public ArrayOpenHashIndexedDouble2ObjMap<Value> clone() {
        ArrayOpenHashIndexedDouble2ObjMap<Value> c;
        try {
            c=(ArrayOpenHashIndexedDouble2ObjMap<Value>) super.clone();
        }
