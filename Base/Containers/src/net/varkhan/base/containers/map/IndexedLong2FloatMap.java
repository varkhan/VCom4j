 ...
 * @time 3:37:27 AM
 */
public interface IndexedLong2FloatMap extends IndexedMap<Long,Float>/*, IndexedObj2FloatMap<Long>, IndexedLong2ObjMap<Float>*/ {
     ...
     */
    public interface Entry extends IndexedMap.Entry<Long,Float>, IndexedObj2FloatMap.Entry<Long>, IndexedLong2ObjMap.Entry<Float> {
     ...
     */
    public long add(long key, float val);
     ...
     */
    public Iterator<? extends IndexedLong2FloatMap.Entry> iterator();
     ...
     */
    public Iterable<? extends IndexedLong2FloatMap.Entry> iterate(long[] indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedLong2FloatMap.Entry> iterate(java.lang.Iterable<Long> indexes);
     ...
     * @return an iterable over all the elements associated to the identifiers
     */
    public Iterable<? extends IndexedLong2FloatMap.Entry> iterate(Indexable indexes);
