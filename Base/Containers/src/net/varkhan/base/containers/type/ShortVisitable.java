 ...
 * @time 4:31:51 AM
 */
public interface ShortVisitable extends Visitable<Short> {

    public interface ShortVisitor<Par> {
        /**
         ...
         */
        public long invoke(short obj, Par par);
    }
     ...
     */
    public <Par> long visit(ShortVisitor<Par> vis, Par par);
