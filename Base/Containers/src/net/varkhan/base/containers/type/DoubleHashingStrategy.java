 ...
 * @time 11:49:49 PM
 */
public interface DoubleHashingStrategy extends HashingStrategy<Double> {
     ...
     */
    public static final DoubleHashingStrategy DefaultHashingStrategy=new DoubleHashingStrategy() {
