 ...
 * @time 8:43 PM
 */
public class ArrayOpenHashLong2ObjMapTest extends AbstractLong2ObjMapTest {
    ...
    public void testAdd() throws Exception {
        ...
        Long2ObjMap<String> map = new ArrayOpenHashLong2ObjMap<String>();
    ...
    public void testEquals() throws Exception {
        ...
        String[] vals=genValueStrings(rand, 100000, .1, 2, 5, "abcdefghijklmnopqrstuvwxyz".toCharArray());
        Long2ObjMap<String> map = new ArrayOpenHashLong2ObjMap<String>();
        featureTestEquals(rand, keys, vals, map, new ArrayOpenHashLong2ObjMap<String>(), 0);
    }
    ...
    public void testClone() throws Exception {
        ...
        long[] keys=genKeyLongs(rand, 100000);
        String[] vals=genValueStrings(rand, 100000, .1, 2, 5, "abcdefghijklmnopqrstuvwxyz".toCharArray());
        ArrayOpenHashLong2ObjMap<String> map = new ArrayOpenHashLong2ObjMap<String>();
