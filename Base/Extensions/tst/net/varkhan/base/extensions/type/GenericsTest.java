...
public class GenericsTest extends TestCase {
    ...
    public void testGetGenericParameters_DirectConcrete() {
        assertEquals("","[T, U]",
                Arrays.toString(Generics.getGenericParameters( GenInterface2.class, GenInterface2.class)) );
        assertEquals("","[TT, UU]",
                Arrays.toString(Generics.getGenericParameters( GenAbstractX.class, GenInterface2.class)) );
    }
    ...
    public void testGetGenericParameters_IndirectAbstract() {
        ...
        assertEquals("y1","[class java.lang.String]",
                Arrays.toString(Generics.getGenericParameters( y1.getClass(), GenInterface1.class)) );
        assertEquals("y2","[TTT, class java.lang.Integer]",
                Arrays.toString(Generics.getGenericParameters( y1.getClass(), GenInterface2.class)) );
    }
    ...
    public void testGetGenericParameters_IndirectAnonymous() {
        ...
        assertEquals("y3","[class java.lang.String]",
                Arrays.toString(Generics.getGenericParameters( y3.getClass(), GenInterface1.class)) );
        assertEquals("y4","[class java.lang.Boolean, class java.lang.Integer]",
                Arrays.toString(Generics.getGenericParameters( y3.getClass(), GenInterface2.class)) );
    }
    ...
    public void testGetGenericParameters_IndirectConcrete() {
        ...
        assertEquals("x","[class java.lang.Boolean, class java.lang.Integer]",
                Arrays.toString(Generics.getGenericParameters( x.getClass(), GenInterface2.class)) );
    }

    public void testGetBaseClass() {
        assertNull("i1", Generics.getBaseClass(GenInterface1.class.getTypeParameters()[0]));
        ...
        assertEquals("y5", List.class, Generics.getBaseClass(t5.getActualTypeArguments()[0]));
    }
}
