 ...
 * @time 12:33 PM
 */
public interface CTuple<L, _T extends __<?,?>> extends Tuple<L,_T> {
    ...
    public static class Value<L,_T extends __<?,?>> extends Tuple.Value<L,_T> implements CTuple<L,_T> {
        ...
        protected static Class<?>[] rcurry(Class<?>[] values) {
