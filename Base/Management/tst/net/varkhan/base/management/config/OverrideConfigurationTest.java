...
public class OverrideConfigurationTest extends TestCase {
    ...
    public void testGet() throws Exception {
        ...
        cfg2.add("c1", "kx", "x");
        cfg2.add("c2", "k1", 21);
        OverrideConfiguration cfg = new OverrideConfiguration(cfg1,cfg2);
    ...
    public void testAdd() {
        ...
        assertEquals("get(k1)", 1, cfg.get("", "k1"));
        assertEquals("get(kA)", "A", cfg.get("", "kA"));
        assertEquals("get(kB)", "B", cfg.get("", "kB"));
        assertEquals("get1(kB)", null, cfg1.get("", "kB"));
        assertEquals("get(c1,k1)", 11, cfg.get("c1", "k1"));
        assertEquals("get(c1,kA)", "1A", cfg.get("c1", "kA"));
        assertEquals("get(c2,k1)", 21, cfg.get("c2", "k1"));
        assertEquals("get(c2,kA)","2A",cfg.get("c2","kA"));
        cfg.add("kB", "BB");
        assertEquals("get(kB)", "BB", cfg.get("", "kB"));
        assertEquals("get1(kB)", "BB", cfg1.get("", "kB"));
        assertEquals("get2(kB)", "B", cfg2.get("", "kB"));
    }
