 ...
 * @time 12:22 PM
 */
public class ConcurrentStateReportTest extends TestCase {
    ...
    public void testBasicHealthReport() {
        ...
        ConcurrentStateReport<HealthLevel,HealthState> report = new ConcurrentStateReport<HealthLevel,HealthState>(HealthState.HEALTHY, 10);
        report.add(major1);
        report.add(minor2);
        report.add(minor3);
        time[0] = 0;
...
//        };
        ...
        ConcurrentStateReport<LifeLevel,LifeState> report = new ConcurrentStateReport<LifeLevel,LifeState>(LifeState.STOPPED, 10);
        report.add(major1);
//        report.add(minor2);
//        report.add(minor3);
        time[0] = 0;
